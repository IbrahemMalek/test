...
import SignupValidations from '../../../src/services/SignupValidation';
import {
    AUTH_ACTION,
    LOGIN_ACTION,
    AUTO_LOGIN_ACTION,
...
export default {
    ...
    async [LOGIN_ACTION](context, payload) {
        return context.dispatch(AUTH_ACTION, {
            ...payload,
            url: `https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyCgOjJq-vKb65yCLsX0kRqbUodGNCmd530 `,
        });
    },
    ...
    async [SIGNUP_ACTION](context, payload) {
        return context.dispatch(AUTH_ACTION, {
            ...payload,
            url: `https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyCgOjJq-vKb65yCLsX0kRqbUodGNCmd530 `,
        });
    },
